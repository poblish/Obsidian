...
@AssertLookup("jasmine.failed\\(")
@ScenarioScope
class JasmineFailsLookup @Inject constructor(private val jasmineStatus: JasmineRunStatus) {
    ...
    fun lookup(targetIdentifier: String): Collection<AssertTarget> {
        ...
        return LookupUtils.singleTarget(jasmineStatus.fails)
    }
}